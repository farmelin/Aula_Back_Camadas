...
public class CarroBO {
	...
	// classes do BO não possuem atributos nenhum, apenas métodos
	// estes metodos são criados para serem utilizados pelo Main e chamados pelo front end
	// Normalmente são criados com as mesmas caracteristicas dos metodos do DAO mas com nomes diferentes
	...
	public static String  exibirCarros() {
		...
		/*
		 * os objetos acima são os mesmos, e 
		 */
	}
